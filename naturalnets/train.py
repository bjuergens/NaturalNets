...
def train(configuration, results_directory):
    ...
    # Last element of log contains additional info from training
    log_info = dict()
...
if __name__ == '__main__':
    with open("Configuration.json", "r") as readfile:
        configuration = json.load(readfile)
    train(configuration=configuration, results_directory="results")
